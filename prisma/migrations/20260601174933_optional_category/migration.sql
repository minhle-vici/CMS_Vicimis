...
INSERT INTO "new_AccountDetail" ("categoryId", "createdAt", "folderId", "id", "isVisibleToTeam", "name", "note", "password", "username") SELECT "categoryId", "createdAt", "folderId", "id", "isVisibleToTeam", "name", "note", "password", "username" FROM "AccountDetail";
